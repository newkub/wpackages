...
import { parseGitUrl, parseBranchName, parseStatusLine, parseCommitLine, parseBranchLine, parseRemoteLine, parseStashLine, splitLines } from "./parse.utils";
...
describe("parseGitUrl", () => {
	...
	it("should parse HTTPS URL correctly", () => {
		expect(parseGitUrl("https://github.com/user/repo.git")).toEqual({ host: "github.com", owner: "user", repo: "repo" });
	});
