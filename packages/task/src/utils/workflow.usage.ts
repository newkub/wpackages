...
import { executeWorkflow, createWorkflow } from "../services/workflow";
...
async function main() {
    ...
    const transactionalWorkflow = createWorkflow("Transactional Workflow", [step1, step2, step4Failing], { transactional: true });
